...
public class HttpClientUtil {
    ...
    static {
        ...
        try {
            ...
            int connectionRequestTimeout = 5000000;
        ...
        // 设置请求超时时间
        requestConfig = RequestConfig.custom().setSocketTimeout(5000000).setConnectTimeout(5000000)
                .setConnectionRequestTimeout(5000000).build();
    }
    ...
    public static String sendHttpPost(String httpUrl, String params) {
        ...
        httpPost.getParams().setIntParameter("http.soket.timeout",30000);
        try {
            // 设置参数
     ...
     * @throws IOException
     */
    public String getData(String url, String request)throws UnsupportedEncodingException, IOException {
